{!! Form::open(['class' => 'floating-labels delete-ajax', 'url' => route('notes.destroy', ['note' => $note->id])]) !!}
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">@lang('models/note.actions.destroy') - {{ $note->label }}</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <h4 class="text-center text-danger">@lang('global.confirm_delete', ['label' => $note->label])</h4>
            </div>
